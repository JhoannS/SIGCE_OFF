        ...
        <div class="contenido">
            ...
            <div class="filtros">
                ...
                <div class="filtros_nav">
                    <a href="views/lleagada.php"><div class="fa-solid fa-bars-staggered" id="primero"><p>Orden de Llegada</a></div></a>
                    <a href="views/instructor.php"><div class="fa-solid fa-users-viewfinder"><p>Instructor</p></div></a>
                    <a href="views/documento.php"><div class="fa-solid fa-id-card"><p>Documento</p></div></a>
                </div>  
            </div>
