    ...
    <aside>
        <div class="contenido">
            ...
            <div class="filtros">
                ...
                <a href="instructor.php"><div class="fa-solid fa-users-viewfinder" id="primero" ><p>Instructor</p></div></a>
                <a href="documento.php"><div class="fa-solid fa-id-card" ><p>Documento</p></div></a>
                </div>  
            </div>
